...
function main (argc, argv)
    ...
    var ok = 0;
    ok += VS_Setup  ("16.0", "HKCU", "16.0_Config", src + "\\VS");
    ok += VS_Setup  ("15.0", "HKCU", "15.0_Config", src + "\\VS");
    ok += VS_Setup  ("14.0", "HKCU", "14.0_Config", src + "\\VS");
...
//  ok && VS_HelpSetup      (src + "\\VS\\Help");
    ...
    ok += SupportDLLs_CopyFiles (Windows, txFolder + "\\Windows");
...
function SupportDLLs_CopyFiles (dest, src)
    {
    src += "\\";
    ...
    try
        ...
        CopyFile (dest, src + "symsrv32.dll");
        CopyFile (dest, src + "symsrv64.dll");
        CopyFile (dest, src + "symsrv.yes");
